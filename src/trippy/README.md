...
Trippy is your Clippy for helping you level up your roadtrips. Part of the Tripperist family of tools, Trippy's aim is to find out what sort of things you like to do, then crafts a suggested roadtrip.

Trippy is my attempt to learn more about the agent development kit.

## Overview

The goal is to create a multi-agent companion that helps Tripperistas plan epic road trips. The vision is something like this.
  1. Agent to gather logistics, such as origin and destination, number of days, driving style.
  2. Agent to suggest roadtrip themes, historical, foodie, kitsch, music, outdoors, frugality level.
  3. Agent to identify POIs
  4. Agent to map route

# Leftovers from Sample Readme
